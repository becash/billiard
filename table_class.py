...
# Form implementation generated from reading ui file 'table_class.ui'
#
# Created: Thu Feb  9 22:36:05 2017
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tableWidget.horizontalHeaderItem(0).setText("Table  name")
        item = QtGui.QTableWidgetItem()
        self.tableWidget.setHorizontalHeaderItem(1, item)
        self.tableWidget.horizontalHeaderItem(1).setText("Salon")
        item = QtGui.QTableWidgetItem()
        self.tableWidget.setHorizontalHeaderItem(2, item)
        self.tableWidget.horizontalHeaderItem(2).setText("Order")
        item = QtGui.QTableWidgetItem()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tableWidget.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("Dialog", "Price 1", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(5).setText(QtGui.QApplication.translate("Dialog", "Price 2", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(6).setText(QtGui.QApplication.translate("Dialog", "Price 3", None, QtGui.QApplication.UnicodeUTF8))
