...
# Form implementation generated from reading ui file 'user_class.ui'
#
# Created: Thu Feb  9 22:36:02 2017
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tableWidget.horizontalHeaderItem(0).setText("User name")
        item = QtGui.QTableWidgetItem()
        self.tableWidget.setHorizontalHeaderItem(1, item)
        self.tableWidget.horizontalHeaderItem(1).setText("Level")
        item = QtGui.QTableWidgetItem()
        self.tableWidget.setHorizontalHeaderItem(2, item)
        self.tableWidget.horizontalHeaderItem(2).setText("Notes")
        item = QtGui.QTableWidgetItem()
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "User editor", None, QtGui.QApplication.UnicodeUTF8))
