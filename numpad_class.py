...
# Form implementation generated from reading ui file 'numpad_class.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMaximumSize(QtCore.QSize(332, 411))
...
"")
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 271, 291))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 271, 96))
        ...
        self.passLine.setInputMethodHints(QtCore.Qt.ImhNone)
        self.passLine.setText("")
        self.passLine.setEchoMode(QtGui.QLineEdit.Normal)
        ...
        self.bOk = QtGui.QPushButton(self.gridLayoutWidget)
        self.bOk.setToolTip("")
        self.bOk.setStatusTip("")
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 100, 271, 191))
        ...
        self.gridLayout_2.addWidget(self.pushButtonC, 3, 2, 1, 1)
        self.pushButton0 = QtGui.QPushButton(self.gridLayoutWidget_2)
        self.pushButton0.setObjectName("pushButton0")
        self.gridLayout_2.addWidget(self.pushButton0, 3, 1, 1, 1)
        self.pushButtonPlot = QtGui.QPushButton(self.gridLayoutWidget_2)
        self.pushButtonPlot.setObjectName("pushButtonPlot")
        self.gridLayout_2.addWidget(self.pushButtonPlot, 3, 0, 1, 1)

        self.retranslateUi(Dialog)
        QtCore.QObject.connect(self.bCancel, QtCore.SIGNAL("clicked()"), Dialog.reject)
        QtCore.QMetaObject.connectSlotsByName(Dialog)

    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "Numpad", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButtonPlot.setText(QtGui.QApplication.translate("Dialog", ".", None, QtGui.QApplication.UnicodeUTF8))
